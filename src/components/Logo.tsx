  ...
  return (
    <div className={`flex items-center gap-3 group select-none ${className}`}>
      ...
      <div className="relative w-10 h-10 flex items-center justify-center">
        ...
        <span className="relative z-10 text-white font-display text-base font-bold leading-none">A</span>
      </div>

      <div className="flex flex-col">
        <span className={`text-xl font-display font-bold leading-none tracking-tight transition-colors duration-500 ${
          isDark ? 'text-[#1A1A1A] group-hover:text-[#C4A265]' : 'text-white'
        }`}>
          Aura
        </span>
        <span className={`text-[10px] uppercase tracking-[0.22em] font-bold mt-1 ${
